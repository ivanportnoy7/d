...
<div class="uk-grid">
    <div class="uk-width-1-3@s ">
        <div class="uk-form-horizontal uk-margin-medium uk-card uk-card-body uk-card-small uk-card-default">
            <h4 class="uk-heading-line uk-text-center"><span>Ценообразование</span></h4>
			...
			<p><label class="uk-form-label">Отображение Таймера:</label>
				<div class="uk-form-controls">
                <select class="uk-select" name="timer_button">
                    <option value="1" <?php echo ((int) $timer_button === 1) ? 'selected' : "";?>>Включено</option>
                    <option value="0"<?php echo ((int) $timer_button === 0) ? 'selected' : "";?>>Выключено</option>
                </select>
				</div>
			</p>
			<p><label class="uk-form-label">Отображение скидки и старой цены на сайте:</label>
				<div class="uk-form-controls">
                <select class="uk-select" name="skidka_button">
                    <option value="1" <?php echo ((int) $skidka_button === 1) ? 'selected' : "";?>>Включено</option>
                    <option value="0"<?php echo ((int) $skidka_button === 0) ? 'selected' : "";?>>Выключено</option>
                </select>
				</div>
			</p>
			
			
			<h4 class="uk-heading-line uk-text-center"><span>Дополнительные Настройки</span></h4>
			...
			<p><label class="uk-form-label">Название кнопки:</label><div class="uk-form-controls"><input class="uk-input" id="all_button" type="text" name="all_button" value="<?= $all_button ?>" placeholder="Заказать Сейчас"></div></p>
			<p><label class="uk-form-label">Название кнопки при активной функции позвонить:</label><div class="uk-form-controls"><input class="uk-input" id="call_button" type="text" name="call_button" value="<?= $call_button ?>" placeholder="Позвонить"></div></p>
	   </div>


        <div class="uk-form-horizontal uk-margin-medium uk-card uk-card-body uk-card-small uk-card-default">
            <h4 class="uk-heading-line uk-text-center"><span>Отправка информации о покупке:</span></h4>
		...
		<div class="uk-form-horizontal uk-margin-medium uk-card uk-card-body  uk-card-small uk-card-default">
            <a href="../../edit.php" class="uk-button uk-button-danger uk-width-1-1" target="_blank">ПЕРЕЙТИ В ВИЗУАЛЬНЫЙ РЕДАКТОР</a>
        </div> 
    ...
    <div class="uk-width-1-2@s">
        ...
        <div class="uk-form-horizontal uk-margin-medium uk-card uk-card-body  uk-card-small uk-card-default">
            <h4 class="uk-heading-line uk-text-center"><span>Коды:</span></h4>
			...
			<h4 class="uk-heading-line uk-text-center"><span>Функция Позвонить</span></h4>
			<div class="uk-placeholder uk-text-center">Вместо формы заказа на сайте, будет кнопка с Вашим телефоном. При нажатии на нее у человека на телефоне будет открываться вызов вашего абонента.</div>
			<p><label class="uk-form-label">Статус:</label>
				<div class="uk-form-controls">
                <select class="uk-select" name="phone_button">
                    <option value="1" <?php echo ((int) $phone_button === 1) ? 'selected' : "";?>>Включено</option>
                    <option value="0"<?php echo ((int) $phone_button === 0) ? 'selected' : "";?>>Выключено</option>
                </select>
				</div>
			</p>
			<p><label class="uk-form-label" for="manager_phone">Ваш телефон без пробелов и с кодом страны: </label><div class="uk-form-controls"><input class="uk-input" required id="manager_phone" type="text" name="manager_phone" value="<?= $manager_phone; ?>" placeholder="Например: +380503453345"></div></p>
			<p><label class="uk-form-label" for="start_work">Начало Времени показа: </label><div class="uk-form-controls clockpicker" data-placement="left" data-align="top" data-autoclose="true"><input class="uk-input" required id="start_work" type="text" name="start_work" value="<?= $start_work; ?>" placeholder="Начало времени с которого будет включен телефон на кнопке"></div></p>
			<p><label class="uk-form-label" for="end_work">Конец Времени показа: </label><div class="uk-form-controls clockpicker" data-placement="left" data-align="top" data-autoclose="true"><input class="uk-input" required id="end_work" type="text" name="end_work" value="<?= $end_work; ?>" placeholder="Конец времени до которого будет включен телефон на кнопке"></div></p>
			<div class="uk-alert-danger" uk-alert>
				<p>ВНИМАНИЕ! Данная функция работает только на мобильных устройствах и подойдет Вам, если у Вас клиенты только на мобильных устройствах!</p>
			</div>
